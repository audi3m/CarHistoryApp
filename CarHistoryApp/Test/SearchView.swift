...
struct SearchView: View {
    @StateObject var locationManager = LocationManagerKavsoft()
                    ...
                    ForEach(places, id: \.self) { place in
                        Button {
                            if let coordinate = place.location?.coordinate {
                                ...
                                locationManager.updatePlacemark(location: .init(latitude: coordinate.latitude,
                                                                                longitude: coordinate.longitude))
                            }
...
struct MapViewSelection: View {
    @EnvironmentObject var locationManager: LocationManagerKavsoft
